-- Initialize storage camera tracking variables in your script's initialization
-- Put this in your script's on_init or when you initialize your storage table
